...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        public Traveler GetInitialTravelerInfo()
        {
            ...
            //get traveler's living status
            //
            DisplayGamePlayScreen("Mission Initialization - Living Status", Text.InitializeMissionGetTravelerAlive(traveler.Name), ActionMenu.MissionIntro, "");
            DisplayInputBoxPrompt($"Enter 'yes' if you are alive: ");
            traveler.Alive = GetBool();
            ...
            DisplayGamePlayScreen(
                "Mision Initialization - Hoe Planet"
                ,Text.InitializeMissionGetTravelerHomePlanet(traveler.Name)
