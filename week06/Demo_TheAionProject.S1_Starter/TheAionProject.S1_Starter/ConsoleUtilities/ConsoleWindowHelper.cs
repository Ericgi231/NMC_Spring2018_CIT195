...
namespace TheAionProject
{
    ...
    static class ConsoleWindowHelper
    {
        ...
        /// </summary>
        /// <param name="xPos">top left corner x position</param>
        /// <param name="yPos">top left corner y position</param>
        /// <param name="width">box width</param>
        /// <param name="height">box height</param>
        public static void DisplayBoxOutline(int xPos, int yPos, int width, int height)
        {
            string corner = "@";
			string vertical = "-";
			string horizontal = "|";
